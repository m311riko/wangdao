...
int main(int argc,char *argv[])
{
    ...
    log4cpp::OstreamAppender* osAppener2=new log4cpp::OstreamAppender("osAppender2",&cout);
    osAppener2->setLayout(new log4cpp::BasicLayout());
